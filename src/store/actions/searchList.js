...
export const fetchSearchRecipesSuccess = (recipes) => {
	return { type: actionTypes.FETCH_SEARCH_RECIPES_SUCCESS, recipes: recipes };
};

export const fetchSearchRecipesFailed = (error) => {
	return { type: actionTypes.FETCH_SEARCH_RECIPES_FAILED, error: error };
};
...
export const fetchMoreSearchRecipesSuccess = (recipes) => {
	return {
		type: actionTypes.FETCH_MORE_SEARCH_RECIPES_SUCCESS,
		recipes: recipes,
	};
};

export const fetchMoreSearchRecipesFailed = (error) => {
	return { type: actionTypes.FETCH_MORE_SEARCH_RECIPES_FAILED, error: error };
};
...
export const fetchSearchRecipeSuccess = (recipe, id) => {
	return {
		type: actionTypes.FETCH_SEARCH_RECIPE_SUCCESS,
		recipe: recipe,
		id: id,
	};
};
...
export const fetchSearchRecipeFailed = (error) => {
	return { type: actionTypes.FETCH_SEARCH_RECIPE_FAILED, error: error };
};
