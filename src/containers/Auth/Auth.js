...
class Auth extends Component {
	...
	handleInputChange(event, identifier) {
		...
		newControl.valid = this.checkValidity(
			event.target.value,
			newControl.validation
		);
		...
		return (
			<div className="Auth">
				...
				{this.props.loading ? (
					...
					<form
						onSubmit={(e) => this.handleAuthFormSubmit(e)}
						autoComplete="on"
					>
						<Input
							...
							inputConfig={{
								...
								placeholder: this.state.controls.email
									.placeholder,
							}}
						...
						<Input
							...
							inputConfig={{
								...
								placeholder: this.state.controls.password
									.placeholder,
							}}
